<template>
  <div class="tab-content">
    ...
    <n-modal
      ...
      role="dialog"
      aria-modal="true"
      :on-close="() => (showAnalyzeDialog = false)"
    >
      <template #header-extra>
        <n-button quaternary circle @click="closeAnalyzeDialog">
          <template #icon>
            <n-icon>
      ...
      <template #action>
        <div style="display: flex; gap: 12px; justify-content: flex-end">
          <n-button @click="closeAnalyzeDialog"> Cancel </n-button>
    ...
    <div v-else class="header-buttons compact-upload-section">
      ...
      <div style="display: flex; gap: 15px; align-items: center">
        <!-- Fast mode checkbox with tooltip -->
        <div style="display: flex; align-items: center; gap: 8px">
          ...
          <n-tooltip trigger="hover">
            ...
            Fast mode is designed for quick processing of a few photos with
            immediate use. It has storage limitations but provides faster
            analysis compared to normal mode.
          </n-tooltip>
        </div>
